...
hidden_imports = [
    ...
    # Engagement pentest workspace and high-fidelity testing modules.
    'wafpierce.pentest_cli',
    'wafpierce.pentest_models',
    'wafpierce.pentest_policy',
    'wafpierce.pentest_workspace',
    'wafpierce.proofs',
    'wafpierce.recon_ingest',
    'wafpierce.role_diff',
    'wafpierce.raw_transport',
    'wafpierce.recipes',
    'wafpierce.internal_identity',
    'wafpierce.cloud_ingest',
    'wafpierce.auth_workflows',
    'wafpierce.discovery_results',
    'wafpierce.discovery_intelligence',
    'wafpierce.recon_engines',
    'wafpierce.browser_stack',
    'wafpierce.browser_automation',
    'wafpierce.exploit_intelligence',
    'wafpierce.automation_inventory',
    'wafpierce.automation_delivery',
    'wafpierce.automation_validation',
    'wafpierce.automation_ui',
