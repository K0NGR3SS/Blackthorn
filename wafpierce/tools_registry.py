...
_SPECS = [
    ...
    _spec(key='dalfox', name='dalfox', category='vuln', binaries=('dalfox',),
          target_kind='url', version_args=('version',),
          argv_template=('scan', '{url}', '--format', 'jsonl', '--silence'),
          json_mode='stdout_jsonl', parser='parse_dalfox_json',
          install_hint='go install github.com/hahwul/dalfox/v3@latest',
          homepage='https://github.com/hahwul/dalfox'),
    _spec(key='retire', name='Retire.js Site Scanner', category='vuln',
          binaries=('retire-site-scanner',), target_kind='url',
          version_args=('--version',), argv_template=('{url}',),
          json_mode='lines', parser='generic_lines',
          install_hint='npm install -g retire-site-scanner',
          homepage='https://github.com/RetireJS/retire-site-scanner',
